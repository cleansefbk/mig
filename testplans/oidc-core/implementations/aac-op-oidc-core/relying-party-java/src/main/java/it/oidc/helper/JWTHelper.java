...
import it.oidc.config.GlobalOptions;
import it.oidc.exception.JWTException;
import it.oidc.exception.OIDCException;
import it.oidc.util.GetterUtil;
...
public class JWTHelper {
	 ...
	 * Unsigned Jws
	 */
	public String createPlainJWS(JSONObject payload) throws OIDCException {
		try {
			// Prepare JWS object with the payload
			PlainObject jwsObject = new PlainObject(new Payload(payload.toString()));
