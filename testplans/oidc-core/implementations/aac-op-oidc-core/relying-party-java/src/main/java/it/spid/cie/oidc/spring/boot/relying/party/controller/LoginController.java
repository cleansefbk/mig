...
public class LoginController {
	...
	public ModelAndView home(HttpServletRequest request)
		...
		ProviderButtonInfo aacProvider = new ProviderButtonInfo("aac", "aac", "");
		List<ProviderButtonInfo> aacProviders = new ArrayList<ProviderButtonInfo>();
		aacProviders.add(aacProvider);
		mav.addObject("aacProviders", aacProviders);
...
//		authorizeRequest.setUi_locales(null);
	...
	public RedirectView revoke(
		...
		if(RelyingPartySession.Status.LOGGED.equals(relyingPartyWrapper.getSession().getStatus())) {
			relyingPartyWrapper.revoke(relyingPartyWrapper.getSession());
		}
		return new RedirectView("login");
	}
	...
	public RedirectView introspect(
		...
		if(RelyingPartySession.Status.LOGGED.equals(relyingPartyWrapper.getSession().getStatus())) {
			relyingPartyWrapper.introspect(relyingPartyWrapper.getSession());
		}
		return new RedirectView("login");
	}
	...
	public RedirectView callback(
		...
		throws Exception {
System.out.println("### signin-callback");
